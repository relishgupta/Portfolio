const About = () => {
  return (
    <div name="about" className="w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white">
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col jutsify-center w-full h-full">
        <div className="pb-8">
        ...
        <br/>
        <p className="text-xl">
        If you are looking for a dedicated and hardworking intern, please consider me for the position. I am excited about the opportunity to learn and grow with your company.
        </p>
      </div>
    </div>
  )
